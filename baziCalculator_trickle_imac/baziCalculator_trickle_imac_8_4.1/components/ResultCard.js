// 导入DaYunAnalysis组件
const DaYunAnalysis = window.DaYunAnalysis || (typeof DaYunAnalysis !== 'undefined' ? DaYunAnalysis : function(props) { return null; });
...
function ResultCard({ bazi, patterns, wuxingResult, shishenResult, shierGongResult, lunarDate, solarDate }) {
  try {
    ...
    const tabs = [
      ...
      { id: 'dayun', label: 'dayunSection', icon: 'fas fa-hourglass-half' },
          ...
          return (
            <div className="tab-pane" data-name="liunian-tab-content">
              <div className="card" data-name="liunian-card">
                ...
                <LiuNianAnalysis bazi={bazi} showDayun={false} />
              </div>
            </div>
          );
        default:
