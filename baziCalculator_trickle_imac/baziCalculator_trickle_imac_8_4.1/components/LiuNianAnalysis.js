function LiuNianAnalysis({ bazi, showDayun = false }) {
  try {
    ...
    if (!bazi) {
      return (
        <div className="analysis-item" data-name="liunian-analysis-empty">
          <div className="analysis-title">{t('liunianTitle') || '流年分析'}</div>
    ...
    return (
      <div className="analysis-item slide-in" data-name="liunian-analysis">
        <div className="analysis-content">
          <div className="pattern-section" data-name="liunian-recent">
            <div className="pattern-section-header">
              <i className="fas fa-calendar-alt text-accent-color mr-2"></i>
              <h4 className="font-semibold">{t('recent_liunian_analysis') || '近期流年分析'}</h4>
          ...
          <div className="pattern-section mt-4" data-name="liunian-future">
            <div className="pattern-section-header">
              <i className="fas fa-hourglass-end text-accent-color mr-2"></i>
              <h4 className="font-semibold">{t('future_thirty_years') || '未来流年详解'}</h4>
              <div className="pattern-section-line"></div>
            </div>
